  ...
  `;
    ...
    const checkWinner = () => {
        if (player1.score >= maxScore)
            ...
            endGame(vsAI ? "AI wins 😢" : "Player 2 wins! 🏆");
    };
    const endGame = (msg) => {
        var _a;
        gameRunning = false;
        ...
        (_a = document.getElementById("restartBtn")) === null || _a === void 0 ? void 0 : _a.classList.remove("hidden");
    };
    const update = () => {
    ...
    const gameLoop = () => { draw(); update(); if (!gameOver)
        requestAnimationFrame(gameLoop); };
    // ===== Controls =====
    document.addEventListener("keydown", e => { if (e.key.toLowerCase() === "w")
        wPressed = true; if (e.key.toLowerCase() === "s")
        sPressed = true; if (e.key === "ArrowUp")
        upPressed = true; if (e.key === "ArrowDown")
        downPressed = true; });
    document.addEventListener("keyup", e => { if (e.key.toLowerCase() === "w")
        wPressed = false; if (e.key.toLowerCase() === "s")
        sPressed = false; if (e.key === "ArrowUp")
        upPressed = false; if (e.key === "ArrowDown")
        downPressed = false; });
    // ===== Buttons =====
    const startAI = document.getElementById("startAI");
    const start1v1 = document.getElementById("start1v1");
    const restartBtn = document.getElementById("restartBtn");
    startAI === null || startAI === void 0 ? void 0 : startAI.addEventListener("click", () => startGame(true));
    start1v1 === null || start1v1 === void 0 ? void 0 : start1v1.addEventListener("click", () => startGame(false));
    restartBtn === null || restartBtn === void 0 ? void 0 : restartBtn.addEventListener("click", () => {
        ...
        startAI === null || startAI === void 0 ? void 0 : startAI.classList.remove("hidden");
        start1v1 === null || start1v1 === void 0 ? void 0 : start1v1.classList.remove("hidden");
    });
    function startGame(vsAIChoice) {
        vsAI = vsAIChoice;
        player1.score = 0;
        player2.score = 0;
        gameOver = false;
        gameRunning = true;
        startAI === null || startAI === void 0 ? void 0 : startAI.classList.add("hidden");
        start1v1 === null || start1v1 === void 0 ? void 0 : start1v1.classList.add("hidden");
        restartBtn === null || restartBtn === void 0 ? void 0 : restartBtn.classList.add("hidden");
        resetBall();
        gameLoop();
    }
}
