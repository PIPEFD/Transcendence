...
function GameOne(app, state) {
    ...
    var wPressed = false, sPressed = false, upPressed = false, downPressed = false;
    ...
    var gameLoop = function () { draw(); update(); if (!gameOver)
