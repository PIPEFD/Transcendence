...
export function Profile1View(app: HTMLElement, state: any): void {
  ...
  export function Profile1View(app: HTMLElement, state: any): void {
    ...
    document.getElementById("userButton")?.addEventListener("click", async () => {
      const usernameInput = document.getElementById("userEnter") as HTMLInputElement | null;
      const emailInput = document.getElementById("mailEnter") as HTMLInputElement | null;
      const passwordInput = document.getElementById("passEnter") as HTMLInputElement | null;
